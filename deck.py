...
def end_turn_status(hand):
  '''Returns the status at the end of a player's turn.
    ...
    Examples:
        end_turn_status(18) returns ''
        end_turn_status(21) returns 'BLACKJACK!'
        end_turn_status(23) returns 'BUST.'
    '''
  if hand == 21:
    return 'BLACKJACK!'
  if hand > 21:
...
def end_game_status(user_hand, dealer_hand):
  '''Prints the winner based on the final hands.
    ...
    Examples:
        end_game_status(21, 19) returns 'You win!'
        end_game_status(23, 20) returns 'Dealer wins!'
        end_game_status(24, 26) returns 'Tie.'
    '''
